...
class TestModelLoading(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        repo_owner = "ADITYA-kus"
        repo_name = "mlops_mini_pipeline"

        # Set up MLflow tracking URI
        mlflow.set_tracking_uri(f'{dagshub_url}/{repo_owner}/{repo_name}.mlflow')

        # Load the new model from MLflow model registry
        cls.new_model_name = "my_logistic_regression_model"
        ...
        cls.holdout_data = pd.read_csv(os.path.join('data', 'features_store', 'testing_feature.csv'))
